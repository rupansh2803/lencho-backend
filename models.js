...
const productSchema = new mongoose.Schema({
  ...
  diamondCut: { type: String, default: '' },
...
const inquirySchema = new mongoose.Schema({
  ...
  adminEmailStatus: { type: String, enum: ['pending', 'sent', 'failed', 'skipped'], default: 'pending' },
  customerEmailStatus: { type: String, enum: ['pending', 'sent', 'failed', 'skipped'], default: 'pending' },
